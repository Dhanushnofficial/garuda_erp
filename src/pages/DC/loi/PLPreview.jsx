    ...
    <>
      ...
      <div className="min-h-screen bg-[#E5E7EB] p-6 ml-[250px]">
        ...
        <div className="no-print flex justify-between items-center mb-6">
          ...
          <button
            onClick={handlePrint}
            className="bg-[#0B1F3A] text-white px-8 py-4 rounded-2xl shadow-lg flex items-center gap-3"
          >
            <FaPrint />
            Print RDC
          </button>
        ...
        <div
          id="print-area"
          className="relative bg-white mx-auto shadow-xl overflow-hidden flex flex-col justify-between"
          style={{
            width: "210mm",
            minHeight: "297mm",
            padding: "10mm",
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none z-0">
            <img
              src={logo_watermark}
              alt="Watermark"
              className="w-[480px] object-contain opacity-[0.08] watermark-print"
            />
          </div>
          ...
          <div className="relative z-10 mt-auto pt-8">
            ...
            <div className="border-t border-slate-300 pt-4 flex justify-between text-[10px] text-slate-500">
              <div>
                ...
                <p>
                  Garuda Aerospace Private . | Alwarpet, Chennai,
                  Tamil Nadu 600018.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  Agni College of Technology, OMR, Thazhambur,
                  Chennai 600130.
                </p>
              </div>
